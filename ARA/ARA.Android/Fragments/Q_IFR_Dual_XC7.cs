...
{
    public class Q_IFR_Dual_XC7 : Android.Support.V4.App.Fragment
    {
        ...
        public override void OnActivityCreated(Bundle savedInstanceState)
        {
            ...
            sc.defaultVals(ans11, ans12, ans13, ans1, Q_IFR_Dual_XC_8Alternate.questionArray[Q_IFR_Dual_XC_8Alternate.questionNum]); //CHANGE
