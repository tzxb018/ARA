...
namespace ARA.Droid
{
	[Activity (Label = "UNO Flight Risk Assessment",  ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait, MainLauncher = true)] //, MainLauncher = true)] // Theme="@style/MainTheme", 
