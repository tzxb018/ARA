...
{
    public class Q_IFR_Dual_XC4 : Android.Support.V4.App.Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            q1.Text = "Fuel at Alternate";
            ans11.Text = "> 90 min";
            ans12.Text = "76 - 90 min";
            ans13.Text = "60 - 75 min";

            q2.Text = "Alternate Airfields";
            ans21.Text = "3+";
            ans22.Text = "2";
            ans23.Text = "1";
